...
var sDownload = {
  prefix: "far",
  iconName: "download",
  icon: [512, 512, [], "", "M29,462L29,462c0-7.2,6.1-13,13.6-13h435.9c7.5,0,13.6,5.8,13.6,13v1.1c0,7.2-6.1,13-13.6,13c-67.7-0.2-368.1-1.2-435.8-1.1 C35.1,474.9,29,469.1,29,462z M253.2,20.5c0.1,62.1-0.8,337.9-1,400c0,6.9,5.3,12.5,11.9,12.5h1c6.6,0,11.9-5.6,11.9-12.5V20.5 c0-6.9-5.3-12.5-11.9-12.5l0,0C258.5,8,253.2,13.6,253.2,20.5z M119.4,294.1c33.6,33.2,146.1,146.4,146.1,146.4l146.3-146.3 c5.1-5.1,5.1-13.3,0-18.3l-0.7-0.7c-5.1-5.1-13.3-5.1-18.3,0L274.2,393.8c-5.1,5.1-13.3,5.1-18.3,0L137.7,275.7 c-5.1-5.1-13.3-5.1-18.3,0l0,0C114.2,280.8,114.3,289,119.4,294.1z"]
};
/* sample object
var sample = {
  prefix: "far",
...
var _iconsCache = {
  ...
  sSquare: sSquare,
  sCircle: sCircle,
  sCirclePlus: sCirclePlus,
  sDownload: sDownload,
};

export { _iconsCache as far, prefix, sHistory,sSquare,sCircle ,sDownload};
